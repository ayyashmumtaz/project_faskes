                   ...
                   <table class="table table-hover table-bordered">
                      ...
                      <tr>
                         ...
                         <td>
                            ...
                            <a href="<?= base_url('Master/delete?nama=') . $faskes->id ?>" class="pr-2 text-danger" onclick="if(!confirm('Anda Yakin Menghapus Data Faskes Bernama, <?= $faskes->nama ?> ?')) {return false}">
